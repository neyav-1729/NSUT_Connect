export function createWelcomeEmailTemplate(name, profileUrl) {
  ...
  <head>
    ...
    <title>Welcome to NsutConnect</title>
  </head>
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(to right,rgb(246, 142, 130),rgb(215, 95, 65)); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
      <img src="https://i.postimg.cc/Pfb2DfN6/Netaji-Subhas-University-of-Technology-svg.png" style="width: 150px; margin-bottom: 20px;border-radius: 10px;">
      <h1 style="color: white; margin: 0; font-size: 28px;">Welcome to NsutConnect</h1>
    </div>
    <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
      <p style="font-size: 18px; color:rgb(236, 79, 58);"><strong>Hello ${name},</strong></p>
      <p>We're thrilled to have you join our professional community! NsutConnect is your platform to connect, learn, and grow in your career.</p>
      ...
      <p>Best regards,<br>The NsutConnect Team</p>
    </div>
  </body>
  </html>
  `;
