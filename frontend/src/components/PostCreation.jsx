...
const PostCreation = ({ user }) => {
	...
	return (
		<div className='bg-white-600 rounded-lg shadow mb-4 p-4'>
			...
			<div className='flex justify-between items-center mt-4'>
				<div className='flex space-x-4'>
					<label className='flex items-center text-black text-black hover:text-info-dark transition-colors duration-200 cursor-pointer'>
				...
				<button
					className='bg-orange-400 text-white rounded-lg px-4 py-2 hover:bg-primary-dark transition-colors duration-200'
